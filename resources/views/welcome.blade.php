...
<html lang="en">
    <head>
        ...
        <title>Start Treinamento Ministerial</title>
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="{{ asset('heroic/assets/favicon.ico') }}" />
        <!-- Bootstrap icons-->
        <link href="{{ asset('heroic/assets') }}" rel="stylesheet" />
        <!-- Core theme CSS (includes Bootstrap)-->
        <link href="{{ asset('heroic/css/styles.css') }}" rel="stylesheet" />
    </head>
    <body>
        <!-- Responsive navbar-->
            ...
            <div class="container px-lg-5">
                <div class="p-4 p-lg-5 bg-light rounded-3 text-center">
                    <div class="m-4 m-lg-5">
                        <h1 class="display-5 fw-bold">Shalom, Bem vindo!!</h1>
                        <p class="fs-4">Nós da Start - Treinamento Ministerial estamos aqui para juntos nos aprofundarmos nas Sagradas Escrituras</p>

                        @auth
                            <a class="btn btn-primary btn-lg" href="{{ route('redirect.after.login') }}">Acessar o Sistema</a>
                        @else
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Start Treinamento Ministerial 2025</p></div>
        </footer>
        <!-- Bootstrap core JS-->
        <script src="{{ asset('heroic/js/scripts.js') }}"></script>
        <!-- Core theme JS-->
        <script src="{{ asset('heroic/js/scripts.js') }}"></script>
    </body>
</html>
